...
class CloudantV1 extends cloudantBaseService_1.CloudantBaseService {
    ...
    postDocument(params) {
        ...
        let body;
        if (_params.document instanceof node_stream_1.Readable || _params.document instanceof Buffer) {
    ...
    postBulkDocs(params) {
        ...
        let body;
        if (_params.bulkDocs instanceof node_stream_1.Readable || _params.bulkDocs instanceof Buffer) {
