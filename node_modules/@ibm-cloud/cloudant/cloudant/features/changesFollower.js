...
class ChangesFollower {
    ...
    constructor(client, params, errorTolerance) {
        ...
        if (readTimeout > 0 &&
            ...
            throw new Error('To use ChangesFollower the client read timeout must be at least ' +
                `${changesParamsHelper_1.ChangesParamsHelper.MIN_CLIENT_TIMEOUT} ms. The client read timeout is ${readTimeout} ms.`);
        }
    }
    /**
